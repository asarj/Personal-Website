            ...
            <div className="project-container">
                    ...
                    <Card.Body className="align-item-center justify-content-center">
                        ...
                        <Card.Subtitle className=" project-gallery-card-subheading text-center d-xl-flex flex-shrink-1 flex-wrap justify-content-xl-center align-items-xl-center"
                            ...
                            {props.project.languages && props.project.languages.map((lang, idx) => (
                                <Button className="btn btn-dark shadow text-center d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center lang-btn">
                                    <strong>{lang}</strong>
                                </Button>
                            ))}
                        </Card.Subtitle>
                ...
                <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false} aria-labelledby="contained-modal-title-vcenter" centered size="lg">
                    <div>
                        ...
                        <Modal.Body>
                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>
                                    ...
                                    <br />
                                    {props.project.languages && props.project.languages.map((lang, idx) => (
                                        <Button className="btn btn-dark shadow lang-btn">
                                            <strong>{lang}</strong>
                                        </Button>
                                    ))}
                                </ListGroup.Item>
                        ...
                        <Modal.Footer>
                            <Button className="btn btn-dark shadow visit" onClick={handleClose}>CLOSE</Button>
                            <Button className="btn btn-dark shadow visit" href={props.project.link} target="_blank">GITHUB REPO</Button>
                        </Modal.Footer>
                    </div>
                </Modal>	
                <div className="over" >
                    <Button className="btn btn-dark shadow see-more" onClick={handleShow}>DETAILS</Button>
