		...
		<div className="App">
			...
			<section id="cv-page" style={{padding: '10px', 'padding-top': '50px', 'padding-bottom': '50px'}}>
					...
					<Card style={{ width: '23rem' }}>
						<Card.Body>
							...
							<Card.Text style={{textAlign: 'left'}}>
								<i class="fas fa-envelope" style={{color: 'rgb(26,43,76)'}}></i>
								&nbsp; &nbsp;
								<a href="mailto:ajay.sarjoo@outlook.com" target="_blank" rel="noopener noreferrer" style={{color: 'black'}}>
									ajay.sarjoo@outlook.com	
								</a>					

								<br />
								
								<i class="fas fa-phone" style={{color: 'rgb(26,43,76)'}}></i>
								&nbsp; &nbsp;
								<a style={{color: 'black'}} style={{pointerEvents: "none"}}>
									Available Upon Request
								</a>

								<br />

								<i class="fab fa-linkedin" style={{color: 'rgb(26,43,76)'}}></i>
								&nbsp; &nbsp;
								<a href="https://www.linkedin.com/in/ajaysarjoo/" target="_blank" rel="noopener noreferrer" style={{color: 'black'}}>
									https://www.linkedin.com/in/ajaysarjoo/
								</a>

								<br />

								<i class="fab fa-github" style={{color: 'rgb(26,43,76)'}}></i>
								&nbsp; &nbsp;
								<a href="https://www.github.com/asarj" target="_blank" rel="noopener noreferrer" style={{color: 'black'}}>
				...
				<div className="wow fadeInUp" data-wow-delay="0.5s">
					...
					<Button id="jump-down" className="resume-btn" onClick={scrollToResume}>JUMP DOWN</Button>
				</div>
				...
				<Container className="flex-wrap justify-content-center align-items-center" style={{textAlign: 'center'}}>
					...
					<Container className="wow fadeInUp" data-wow-delay="0.5s">
						<Button style={{margin: '5px 10px'}} className="resume-btn" href="Resumes/AjaySarjooResume.pdf" target="_blank">PDF (1 PAGE)</Button>
						<Button style={{margin: '5px 10px'}} className="resume-btn" href="Resumes/AjaySarjooCV.pdf" target="_blank">PDF (CV)</Button>
						<Button style={{margin: '5px 10px'}} className="resume-btn" href="Resumes/AjaySarjooResume.txt" target="_blank">TXT</Button>
					</Container>
					<br /> 
					<hr />
				</Container>
