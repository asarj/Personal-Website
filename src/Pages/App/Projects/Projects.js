...
function Projects() {
	...
	const styles = {
		...
		// Comment out below if using Original.css
		// control: (base, state) => ({
		// 	...base,
		// 	background: "#181818",
		// 	// match with the menu
		...
		// 	backgroundColor: state.isSelected ? '#5f5f5f' : '#181818',
		// 	"&:hover": {
		// 	  // Overwrittes the different states of border
		// 	  borderColor: "#949494",
		// 	}
	...
	return (
		<div className="App">
            ...
            <h2 className="text-center section-header"><strong>PROJECT GALLERY</strong></h2>
			<br />
